...
#the label titles are used as the file names, a tool such as NameChanger (https://mrrsoftware.com/namechanger/) could be used to rename as necessary

#import module needed for this script
import json
